...
static /* constexpr */ const MTRDeviceTypeData knownDeviceTypes[] = {
    ...
    { 0x00000020, MTRDeviceTypeClass::Simple, @"Streaming Speaker" },
    { 0x00000021, MTRDeviceTypeClass::Simple, @"Casting Speaker" },
    { 0x00000022, MTRDeviceTypeClass::Simple, @"Volume Controller" },
