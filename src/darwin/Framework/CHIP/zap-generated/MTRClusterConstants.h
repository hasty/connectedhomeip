...
typedef NS_ENUM(uint32_t, MTRClusterIDType) {
    ...
    MTRClusterIDTypeLabelID MTR_PROVISIONALLY_AVAILABLE = 0x00000000,
    ...
    MTRClusterIDTypeTemperatureAlarmID MTR_PROVISIONALLY_AVAILABLE = 0x00000064,
...
typedef NS_ENUM(uint32_t, MTRAttributeIDType) {
    ...
    // Cluster Label attributes
    MTRAttributeIDTypeClusterLabelAttributeLabelListID MTR_PROVISIONALLY_AVAILABLE = 0x00000000,
    MTRAttributeIDTypeClusterLabelAttributeGeneratedCommandListID MTR_PROVISIONALLY_AVAILABLE = MTRAttributeIDTypeGlobalAttributeGeneratedCommandListID,
    MTRAttributeIDTypeClusterLabelAttributeAcceptedCommandListID MTR_PROVISIONALLY_AVAILABLE = MTRAttributeIDTypeGlobalAttributeAcceptedCommandListID,
    MTRAttributeIDTypeClusterLabelAttributeAttributeListID MTR_PROVISIONALLY_AVAILABLE = MTRAttributeIDTypeGlobalAttributeAttributeListID,
    MTRAttributeIDTypeClusterLabelAttributeFeatureMapID MTR_PROVISIONALLY_AVAILABLE = MTRAttributeIDTypeGlobalAttributeFeatureMapID,
    MTRAttributeIDTypeClusterLabelAttributeClusterRevisionID MTR_PROVISIONALLY_AVAILABLE = MTRAttributeIDTypeGlobalAttributeClusterRevisionID,
    ...
    // Cluster TemperatureAlarm attributes
    MTRAttributeIDTypeClusterTemperatureAlarmAttributeMaskID MTR_PROVISIONALLY_AVAILABLE = 0x00000000,
    MTRAttributeIDTypeClusterTemperatureAlarmAttributeLatchID MTR_PROVISIONALLY_AVAILABLE = 0x00000001,
    MTRAttributeIDTypeClusterTemperatureAlarmAttributeStateID MTR_PROVISIONALLY_AVAILABLE = 0x00000002,
    MTRAttributeIDTypeClusterTemperatureAlarmAttributeSupportedID MTR_PROVISIONALLY_AVAILABLE = 0x00000003,
    MTRAttributeIDTypeClusterTemperatureAlarmAttributeCriticalOverTemperatureThresholdID MTR_PROVISIONALLY_AVAILABLE = 0x00000080,
    MTRAttributeIDTypeClusterTemperatureAlarmAttributeMajorOverTemperatureThresholdID MTR_PROVISIONALLY_AVAILABLE = 0x00000081,
    MTRAttributeIDTypeClusterTemperatureAlarmAttributeMinorOverTemperatureThresholdID MTR_PROVISIONALLY_AVAILABLE = 0x00000082,
    MTRAttributeIDTypeClusterTemperatureAlarmAttributeMinorUnderTemperatureThresholdID MTR_PROVISIONALLY_AVAILABLE = 0x00000083,
    MTRAttributeIDTypeClusterTemperatureAlarmAttributeMajorUnderTemperatureThresholdID MTR_PROVISIONALLY_AVAILABLE = 0x00000084,
    MTRAttributeIDTypeClusterTemperatureAlarmAttributeCriticalUnderTemperatureThresholdID MTR_PROVISIONALLY_AVAILABLE = 0x00000085,
    MTRAttributeIDTypeClusterTemperatureAlarmAttributeGeneratedCommandListID MTR_PROVISIONALLY_AVAILABLE = MTRAttributeIDTypeGlobalAttributeGeneratedCommandListID,
    MTRAttributeIDTypeClusterTemperatureAlarmAttributeAcceptedCommandListID MTR_PROVISIONALLY_AVAILABLE = MTRAttributeIDTypeGlobalAttributeAcceptedCommandListID,
    MTRAttributeIDTypeClusterTemperatureAlarmAttributeAttributeListID MTR_PROVISIONALLY_AVAILABLE = MTRAttributeIDTypeGlobalAttributeAttributeListID,
    MTRAttributeIDTypeClusterTemperatureAlarmAttributeFeatureMapID MTR_PROVISIONALLY_AVAILABLE = MTRAttributeIDTypeGlobalAttributeFeatureMapID,
    MTRAttributeIDTypeClusterTemperatureAlarmAttributeClusterRevisionID MTR_PROVISIONALLY_AVAILABLE = MTRAttributeIDTypeGlobalAttributeClusterRevisionID,
    ...
    MTRAttributeIDTypeClusterElectricalAlarmAttributeOverloadThresholdID MTR_PROVISIONALLY_AVAILABLE = 0x00000084,
    MTRAttributeIDTypeClusterElectricalAlarmAttributeUnderloadThresholdID MTR_PROVISIONALLY_AVAILABLE = 0x00000085,
    ...
    MTRAttributeIDTypeClusterElectricalProtectionAlarmAttributeOverCurrentRatingID MTR_PROVISIONALLY_AVAILABLE = 0x00000081,
    MTRAttributeIDTypeClusterElectricalProtectionAlarmAttributeOverVoltageRatingID MTR_PROVISIONALLY_AVAILABLE = 0x00000082,
    MTRAttributeIDTypeClusterElectricalProtectionAlarmAttributeShortCircuitRatingID MTR_PROVISIONALLY_AVAILABLE = 0x00000083,
    MTRAttributeIDTypeClusterElectricalProtectionAlarmAttributeResidualCurrentRatingID MTR_PROVISIONALLY_AVAILABLE = 0x00000084,
    MTRAttributeIDTypeClusterElectricalProtectionAlarmAttributeArcFaultRatingID MTR_PROVISIONALLY_AVAILABLE = 0x00000085,
    ...
    MTRAttributeIDTypeClusterAmbientSensingUnionAttributeSensorIDID MTR_PROVISIONALLY_AVAILABLE = 0x00000002,
    MTRAttributeIDTypeClusterAmbientSensingUnionAttributeSensorListID MTR_PROVISIONALLY_AVAILABLE = 0x00000003,
    MTRAttributeIDTypeClusterAmbientSensingUnionAttributeSensorHealthID MTR_PROVISIONALLY_AVAILABLE = 0x00000004,
    MTRAttributeIDTypeClusterAmbientSensingUnionAttributeUnionHealthID MTR_PROVISIONALLY_AVAILABLE = 0x00000005,
    MTRAttributeIDTypeClusterAmbientSensingUnionAttributeAlivePeriodID MTR_PROVISIONALLY_AVAILABLE = 0x00000006,
    ...
    MTRAttributeIDTypeClusterNetworkIdentityManagementAttributeNetworkIdentifierID MTR_PROVISIONALLY_AVAILABLE = 0x00000000,
    MTRAttributeIDTypeClusterNetworkIdentityManagementAttributeNetworkIdentityID MTR_PROVISIONALLY_AVAILABLE = 0x00000001,
    MTRAttributeIDTypeClusterNetworkIdentityManagementAttributeClientsID MTR_PROVISIONALLY_AVAILABLE = 0x00000002,
    MTRAttributeIDTypeClusterNetworkIdentityManagementAttributeClientTableSizeID MTR_PROVISIONALLY_AVAILABLE = 0x00000003,
    ...
    MTRAttributeIDTypeClusterThreadBorderRouterDiagnosticsAttributeBrStatusID MTR_PROVISIONALLY_AVAILABLE = 0x00000000,
    MTRAttributeIDTypeClusterThreadBorderRouterDiagnosticsAttributeActiveTbrFaultsListID MTR_PROVISIONALLY_AVAILABLE = 0x00000001,
...
typedef NS_ENUM(uint32_t, MTRCommandIDType) {
    ...
    // Cluster TemperatureAlarm commands
    MTRCommandIDTypeClusterTemperatureAlarmCommandResetID MTR_PROVISIONALLY_AVAILABLE = 0x00000000,
    MTRCommandIDTypeClusterTemperatureAlarmCommandModifyEnabledAlarmsID MTR_PROVISIONALLY_AVAILABLE = 0x00000001,
    MTRCommandIDTypeClusterTemperatureAlarmCommandSetTemperatureAlarmThresholdsID MTR_PROVISIONALLY_AVAILABLE = 0x00000080,
    ...
    MTRCommandIDTypeClusterNetworkIdentityManagementCommandEndorseNetworkIdentityUpdateID MTR_PROVISIONALLY_AVAILABLE = 0x00000040,
...
typedef NS_ENUM(uint32_t, MTREventIDType) {
    ...
    // Cluster TemperatureAlarm events
    MTREventIDTypeClusterTemperatureAlarmEventNotifyID MTR_PROVISIONALLY_AVAILABLE = 0x00000000,
...
typedef NS_ENUM(uint32_t, MTRDeviceTypeIDType) {
    ...
    MTRDeviceTypeIDTypeStreamingSpeakerID MTR_PROVISIONALLY_AVAILABLE = 0x00000020,
    MTRDeviceTypeIDTypeCastingSpeakerID MTR_PROVISIONALLY_AVAILABLE = 0x00000021,
    MTRDeviceTypeIDTypeVolumeControllerID MTR_PROVISIONALLY_AVAILABLE = 0x00000022,
