...
@property (nonatomic, copy) NSNumber * _Nullable heatSetpoint MTR_PROVISIONALLY_AVAILABLE;
@property (nonatomic, copy) NSNumber * _Nullable coolSetpoint MTR_PROVISIONALLY_AVAILABLE;
@end
