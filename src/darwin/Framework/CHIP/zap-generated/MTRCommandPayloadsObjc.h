...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRTemperatureAlarmClusterResetParams : NSObject <NSCopying>
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRTemperatureAlarmClusterModifyEnabledAlarmsParams : NSObject <NSCopying>
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRTemperatureAlarmClusterSetTemperatureAlarmThresholdsParams : NSObject <NSCopying>

@property (nonatomic, copy) NSNumber * _Nullable criticalOverTemperatureThreshold MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSNumber * _Nullable majorOverTemperatureThreshold MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSNumber * _Nullable minorOverTemperatureThreshold MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSNumber * _Nullable minorUnderTemperatureThreshold MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSNumber * _Nullable majorUnderTemperatureThreshold MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSNumber * _Nullable criticalUnderTemperatureThreshold MTR_PROVISIONALLY_AVAILABLE;
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
...
@property (nonatomic, copy) NSNumber * _Nullable overloadThreshold MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSNumber * _Nullable underloadThreshold MTR_PROVISIONALLY_AVAILABLE;
...
@property (nonatomic, copy) NSNumber * _Nullable clientNumber MTR_PROVISIONALLY_AVAILABLE;
...
MTR_PROVISIONALLY_AVAILABLE
@interface MTRNetworkIdentityManagementClusterEndorseNetworkIdentityUpdateParams : NSObject <NSCopying>

@property (nonatomic, copy) NSData * _Nonnull networkIdentifier MTR_PROVISIONALLY_AVAILABLE;

@property (nonatomic, copy) NSArray * _Nonnull previousNetworkIdentifiers MTR_PROVISIONALLY_AVAILABLE;
...
@property (nonatomic, copy) NSNumber * _Nullable audioOutputIndex MTR_AVAILABLE(ios(18.4), macos(15.4), watchos(11.4), tvos(18.4));
/**
 * Controls whether the command is a timed command (using Timed Invoke).
 *
 * If nil (the default value), a regular invoke is done for commands that do
