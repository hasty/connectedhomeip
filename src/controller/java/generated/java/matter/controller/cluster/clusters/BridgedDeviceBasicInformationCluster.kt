...
class BridgedDeviceBasicInformationCluster(
  ...
  suspend fun readDeviceLocationAttribute(): DeviceLocationAttribute {
    ...
    // Decode the TLV data into the appropriate type
    val tlvReader = TlvReader(attributeData.data)
    val decodedValue: BridgedDeviceBasicInformationClusterLocationDescriptorStruct? =
      if (!tlvReader.isNull()) {
        if (tlvReader.isNextTag(AnonymousTag)) {
          BridgedDeviceBasicInformationClusterLocationDescriptorStruct.fromTlv(
            AnonymousTag,
            tlvReader,
          )
        } else {
  ...
  suspend fun writeDeviceLocationAttribute(
    value: BridgedDeviceBasicInformationClusterLocationDescriptorStruct,
