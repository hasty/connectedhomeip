...
public:
    ...
    CHIP_ERROR Write(const AttributeAccessContext & context, const app::ConcreteDataAttributePath & aPath,
                     app::AttributeValueDecoder & aDecoder) override;
};

TestAttrAccess gAttrAccess;

CHIP_ERROR TestAttrAccess::Read(const AttributeAccessContext & context, const app::ConcreteReadAttributePath & aPath,
...
CHIP_ERROR TestAttrAccess::Write(const AttributeAccessContext & context, const app::ConcreteDataAttributePath & aPath,
