...
CHIP_ERROR BasicAttrAccess::Read(const AttributeAccessContext & context, const ConcreteReadAttributePath & aPath,
...
CHIP_ERROR BasicAttrAccess::Write(const AttributeAccessContext & context, const ConcreteDataAttributePath & aPath,
