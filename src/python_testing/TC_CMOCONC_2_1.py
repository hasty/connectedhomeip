...
cluster = Clusters.CarbonMonoxideConcentrationMeasurement

class CMOCONC_2_1(MatterBaseTest):

    def desc_CMOCONC_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_CMOCONC_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["CMOCONC.S"]

    def steps_CMOCONC_2_1(self) -> list[TestStep]:
        steps = [
    ...
    @run_if_endpoint_matches(has_cluster(Clusters.CarbonMonoxideConcentrationMeasurement))
    async def test_CMOCONC_2_1(self):
        ...
        if await self.attribute_guard(endpoint=endpoint, attribute=attributes.MeasurementUnit):
            ...
            matter_asserts.assert_valid_enum(val, "MeasurementUnit attribute must return a MeasurementUnitEnum", cluster.Enums.MeasurementUnitEnum)
        ...
        matter_asserts.assert_valid_enum(val, "MeasurementMedium attribute must return a MeasurementMediumEnum", cluster.Enums.MeasurementMediumEnum)
