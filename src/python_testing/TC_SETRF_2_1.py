...
class SETRF_2_1(MatterBaseTest):
    ...
    async def test_SETRF_2_1(self):
        ...
        if val is not NullValue:
            asserts.assert_true(isinstance(val, Clusters.CommodityTariff.Structs.TariffInformationStruct),
                                        f"val must be of type Clusters.CommodityTariff.Structs.TariffInformationStruct")
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(val,  "DayEntries attribute must contain Clusters.CommodityTariff.Structs.DayEntryStruct elements", Clusters.CommodityTariff.Structs.DayEntryStruct)
            for item in val:
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(val,  "DayPatterns attribute must contain Clusters.CommodityTariff.Structs.DayPatternStruct elements", Clusters.CommodityTariff.Structs.DayPatternStruct)
            for item in val:
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(val,  "CalendarPeriods attribute must contain Clusters.CommodityTariff.Structs.CalendarPeriodStruct elements", Clusters.CommodityTariff.Structs.CalendarPeriodStruct)
            for item in val:
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(val,  "IndividualDays attribute must contain Clusters.CommodityTariff.Structs.DayStruct elements", Clusters.CommodityTariff.Structs.DayStruct)
            for item in val:
        ...
        if val is not NullValue:
            asserts.assert_true(isinstance(val, Clusters.CommodityTariff.Structs.DayStruct),
                                        f"val must be of type Clusters.CommodityTariff.Structs.DayStruct")
        ...
        if val is not NullValue:
            asserts.assert_true(isinstance(val, Clusters.CommodityTariff.Structs.DayEntryStruct),
                                        f"val must be of type Clusters.CommodityTariff.Structs.DayEntryStruct")
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(val,  "TariffComponents attribute must contain Clusters.CommodityTariff.Structs.TariffComponentStruct elements", Clusters.CommodityTariff.Structs.TariffComponentStruct)
            for item in val:
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(val,  "TariffPeriods attribute must contain Clusters.CommodityTariff.Structs.TariffPeriodStruct elements", Clusters.CommodityTariff.Structs.TariffPeriodStruct)
            for item in val:
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(val,  "CurrentTariffComponents attribute must contain Clusters.CommodityTariff.Structs.TariffComponentStruct elements", Clusters.CommodityTariff.Structs.TariffComponentStruct)
            for item in val:
                await self.test_checkTariffComponentStruct(endpoint=endpoint, cluster=cluster, struct=item)
        ...
        if val is not NullValue:
            ...
            matter_asserts.assert_list_element_type(val,  "NextTariffComponents attribute must contain Clusters.CommodityTariff.Structs.TariffComponentStruct elements", Clusters.CommodityTariff.Structs.TariffComponentStruct)
            for item in val:
                await self.test_checkTariffComponentStruct(endpoint=endpoint, cluster=cluster, struct=item)
    ...
    async def test_checkAuxiliaryLoadSwitchSettingsStruct(self, 
        ...
        matter_asserts.assert_valid_enum(struct.requiredState, "RequiredState attribute must return a Clusters.CommodityTariff.Enums.AuxiliaryLoadSettingEnum", Clusters.CommodityTariff.Enums.AuxiliaryLoadSettingEnum)
    ...
    async def test_checkDayEntryStruct(self, 
        ...
        if struct.randomizationType is not None:
            matter_asserts.assert_valid_enum(struct.randomizationType, "RandomizationType attribute must return a Clusters.CommodityTariff.Enums.DayEntryRandomizationTypeEnum", Clusters.CommodityTariff.Enums.DayEntryRandomizationTypeEnum)
    ...
    async def test_checkDayStruct(self, 
        ...
        matter_asserts.assert_valid_enum(struct.dayType, "DayType attribute must return a Clusters.CommodityTariff.Enums.DayTypeEnum", Clusters.CommodityTariff.Enums.DayTypeEnum)
        matter_asserts.assert_list(struct.dayEntryIDs, "DayEntryIDs attribute must return a list")
        matter_asserts.assert_list_element_type(struct.dayEntryIDs,  "DayEntryIDs attribute must contain int elements", int)
        asserts.assert_greater_equal(len(struct.dayEntryIDs), 1, "DayEntryIDs must have at least 1 entries!")
        asserts.assert_less_equal(len(struct.dayEntryIDs), 96, "DayEntryIDs must have at most 96 entries!")
    ...
    async def test_checkPeakPeriodStruct(self, 
        ...
        matter_asserts.assert_valid_enum(struct.severity, "Severity attribute must return a Clusters.CommodityTariff.Enums.PeakPeriodSeverityEnum", Clusters.CommodityTariff.Enums.PeakPeriodSeverityEnum)
    ...
    async def test_checkTariffComponentStruct(self, 
        ...
        if struct.price is not NullValue and struct.price is not None:
            asserts.assert_true(isinstance(struct.price, Clusters.CommodityTariff.Structs.TariffPriceStruct),
                                        f"struct.price must be of type Clusters.CommodityTariff.Structs.TariffPriceStruct")
        ...
        if struct.auxiliaryLoad is not None:
            asserts.assert_true(isinstance(struct.auxiliaryLoad, Clusters.CommodityTariff.Structs.AuxiliaryLoadSwitchSettingsStruct),
                                        f"struct.auxiliaryLoad must be of type Clusters.CommodityTariff.Structs.AuxiliaryLoadSwitchSettingsStruct")
        ...
        if struct.peakPeriod is not None:
            asserts.assert_true(isinstance(struct.peakPeriod, Clusters.CommodityTariff.Structs.PeakPeriodStruct),
                                        f"struct.peakPeriod must be of type Clusters.CommodityTariff.Structs.PeakPeriodStruct")
            await self.test_checkPeakPeriodStruct(endpoint=endpoint, cluster=cluster, struct=struct.peakPeriod)
        if struct.powerThreshold is not None:
            asserts.assert_true(isinstance(struct.powerThreshold, Globals.Structs.PowerThresholdStruct),
                                        f"struct.powerThreshold must be of type Globals.Structs.PowerThresholdStruct")
    ...
    async def test_checkTariffInformationStruct(self, 
        ...
        if struct.blockMode is not NullValue:
            matter_asserts.assert_valid_enum(struct.blockMode, "BlockMode attribute must return a Clusters.CommodityTariff.Enums.BlockModeEnum", Clusters.CommodityTariff.Enums.BlockModeEnum)
    ...
    async def test_checkTariffPriceStruct(self, 
        ...
        matter_asserts.assert_valid_enum(struct.priceType, "PriceType attribute must return a Globals.Enums.TariffPriceTypeEnum", Globals.Enums.TariffPriceTypeEnum)
