...
cluster = Clusters.PM10ConcentrationMeasurement

class PMKCONC_2_1(MatterBaseTest):

    def desc_PMKCONC_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_PMKCONC_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["PMKCONC.S"]

    def steps_PMKCONC_2_1(self) -> list[TestStep]:
        steps = [
    ...
    @run_if_endpoint_matches(has_cluster(Clusters.PM10ConcentrationMeasurement))
    async def test_PMKCONC_2_1(self):
