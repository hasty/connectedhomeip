...
class I_2_1(MatterBaseTest):

    def desc_I_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_I_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["I.S"]

    def steps_I_2_1(self) -> list[TestStep]:
        steps = [
    ...
    async def test_I_2_1(self):
        ...
        self.step("1")
        val = await self.read_single_attribute_check_success(endpoint=endpoint, cluster=cluster, attribute=cluster.Attributes.IdentifyTime)
        matter_asserts.assert_valid_uint16(val, 'IdentifyTime')
