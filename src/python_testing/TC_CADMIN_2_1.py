...
class CADMIN_2_1(MatterBaseTest):

    def desc_CADMIN_2_1(self) -> str:
    ...
    def steps_CADMIN_2_1(self) -> list[TestStep]:
        steps = [
            TestStep("1", "Read WindowStatus attribute"),
    ...
    async def test_CADMIN_2_1(self):
        ...
        if val is not NullValue:
            matter_asserts.assert_valid_uint8(val, 'AdminFabricIndex must be uint8')
