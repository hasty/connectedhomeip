...
cluster = Clusters.ModeBase

class MODB_2_1(MatterBaseTest):

    def desc_MODB_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_MODB_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["MODB.S"]

    def steps_MODB_2_1(self) -> list[TestStep]:
        steps = [
    ...
    async def test_checkModeOptionStruct(self, 
        ...
        matter_asserts.assert_list_element_type(struct.modeTags,  "ModeTags attribute must contain ModeTagStruct elements", cluster.Structs.ModeTagStruct)
