...
class TMP_2_1(MatterBaseTest):

    def desc_TMP_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_TMP_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["TMP.S"]

    def steps_TMP_2_1(self) -> list[TestStep]:
        steps = [
    ...
    @run_if_endpoint_matches(has_cluster(Clusters.TemperatureMeasurement))
    async def test_TMP_2_1(self):
        ...
        if self.MinMeasuredValue is not NullValue:
            ...
            asserts.assert_greater_equal(self.MinMeasuredValue, -27315)
