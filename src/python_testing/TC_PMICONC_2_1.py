...
cluster = Clusters.PM25ConcentrationMeasurement

class PMICONC_2_1(MatterBaseTest):

    def desc_PMICONC_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_PMICONC_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["PMICONC.S"]

    def steps_PMICONC_2_1(self) -> list[TestStep]:
        steps = [
    ...
    @run_if_endpoint_matches(has_cluster(Clusters.PM25ConcentrationMeasurement))
    async def test_PMICONC_2_1(self):
