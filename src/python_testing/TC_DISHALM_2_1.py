...
cluster = Clusters.DishwasherAlarm

class DISHALM_2_1(MatterBaseTest):

    def desc_DISHALM_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_DISHALM_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["DISHALM.S"]

    def steps_DISHALM_2_1(self) -> list[TestStep]:
        steps = [
    ...
    async def test_DISHALM_2_1(self):
        ...
        # Check bitmap value less than or equal to (InflowError | DrainError | DoorError | TempTooLow | TempTooHigh | WaterLevelError)
