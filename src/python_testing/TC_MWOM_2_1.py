...
cluster = Clusters.MicrowaveOvenMode

class MWOM_2_1(MatterBaseTest):

    def desc_MWOM_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_MWOM_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["MWOM"]

    def steps_MWOM_2_1(self) -> list[TestStep]:
        steps = [
    ...
    async def test_checkModeOptionStruct(self, 
                                 endpoint: int = None, 
                                 cluster: Clusters.MicrowaveOvenMode = None, 
