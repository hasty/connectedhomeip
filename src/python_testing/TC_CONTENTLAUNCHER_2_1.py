...
class CONTENTLAUNCHER_2_1(MatterBaseTest):

    def desc_CONTENTLAUNCHER_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_CONTENTLAUNCHER_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["CONTENTLAUNCHER.S"]

    def steps_CONTENTLAUNCHER_2_1(self) -> list[TestStep]:
        steps = [
    ...
    async def test_CONTENTLAUNCHER_2_1(self):
        ...
        if await self.attribute_guard(endpoint=endpoint, attribute=attributes.AcceptHeader):
            ...
            asserts.assert_less_equal(len(val), 100, "AcceptHeader must have at most 100 entries!")
            for val in val:
