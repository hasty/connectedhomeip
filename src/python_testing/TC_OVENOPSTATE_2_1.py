...
class OVENOPSTATE_2_1(MatterBaseTest):

    def desc_OVENOPSTATE_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_OVENOPSTATE_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["OVENOPSTATE.S"]

    def steps_OVENOPSTATE_2_1(self) -> list[TestStep]:
        steps = [
    ...
    @run_if_endpoint_matches(has_cluster(Clusters.OvenCavityOperationalState))
    async def test_OVENOPSTATE_2_1(self):
        ...
        matter_asserts.assert_valid_enum(val, "OperationalState attribute must return a OperationalStateEnum", Clusters.OperationalState.Enums.OperationalStateEnum)
    ...
    async def test_checkErrorStateStruct(self, 
                                 endpoint: int = None, 
                                 cluster: Clusters.OvenCavityOperationalState = None, 
