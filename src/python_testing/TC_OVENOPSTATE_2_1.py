...
class OVENOPSTATE_2_1(MatterBaseTest):
    ...
    async def test_OVENOPSTATE_2_1(self):
        ...
        matter_asserts.assert_valid_enum(val, "OperationalState attribute must return a Clusters.OperationalState.Enums.OperationalStateEnum", Clusters.OperationalState.Enums.OperationalStateEnum)
