...
cluster = Clusters.PM1ConcentrationMeasurement

class PMHCONC_2_1(MatterBaseTest):

    def desc_PMHCONC_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_PMHCONC_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["PMHCONC.S"]

    def steps_PMHCONC_2_1(self) -> list[TestStep]:
        steps = [
    ...
    @run_if_endpoint_matches(has_cluster(Clusters.PM1ConcentrationMeasurement))
    async def test_PMHCONC_2_1(self):
