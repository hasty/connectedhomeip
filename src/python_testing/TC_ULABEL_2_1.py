...
cluster = Clusters.UserLabel

class ULABEL_2_1(MatterBaseTest):

    def desc_ULABEL_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_ULABEL_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["ULABEL.S"]

    def steps_ULABEL_2_1(self) -> list[TestStep]:
        steps = [
    ...
    @run_if_endpoint_matches(has_cluster(Clusters.UserLabel))
    async def test_ULABEL_2_1(self):
