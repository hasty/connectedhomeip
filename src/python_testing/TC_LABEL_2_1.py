...
class LABEL_2_1(MatterBaseTest):

    def desc_LABEL_2_1(self) -> str:
    ...
    @run_if_endpoint_matches(has_cluster(Clusters.Label))
    async def test_LABEL_2_1(self):
