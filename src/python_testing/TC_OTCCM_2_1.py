...
class OTCCM_2_1(MatterBaseTest):

    def desc_OTCCM_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_OTCCM_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["OTCCM.S"]

    def steps_OTCCM_2_1(self) -> list[TestStep]:
        steps = [
    ...
    @run_if_endpoint_matches(has_cluster(Clusters.OvenMode))
    async def test_OTCCM_2_1(self):
    ...
    async def test_checkModeOptionStruct(self, 
                                 endpoint: int = None, 
                                 cluster: Clusters.OvenMode = None, 
