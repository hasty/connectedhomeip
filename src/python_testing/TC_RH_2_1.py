...
cluster = Clusters.RelativeHumidityMeasurement

class RH_2_1(MatterBaseTest):

    def desc_RH_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_RH_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["RH.S"]

    def steps_RH_2_1(self) -> list[TestStep]:
        steps = [
    ...
    @run_if_endpoint_matches(has_cluster(Clusters.RelativeHumidityMeasurement))
    async def test_RH_2_1(self):
        ...
        if self.MinMeasuredValue is not NullValue:
            ...
            asserts.assert_less_equal(self.MinMeasuredValue, 9999)
        ...
        if self.MaxMeasuredValue is not NullValue:
            ...
            asserts.assert_less_equal(self.MaxMeasuredValue, 10000)
