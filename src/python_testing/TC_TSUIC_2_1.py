...
cluster = Clusters.ThermostatUserInterfaceConfiguration

class TSUIC_2_1(MatterBaseTest):

    def desc_TSUIC_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_TSUIC_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["TSUIC.S"]

    def steps_TSUIC_2_1(self) -> list[TestStep]:
        steps = [
            TestStep("1", "Read TemperatureDisplayMode attribute"),
