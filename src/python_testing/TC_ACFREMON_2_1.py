...
cluster = Clusters.ActivatedCarbonFilterMonitoring

class ACFREMON_2_1(MatterBaseTest):

    def desc_ACFREMON_2_1(self) -> str:
        """Returns a description of this test"""
        return "Attributes with Server as DUT"

    def pics_ACFREMON_2_1(self) -> list[str]:
        """This function returns a list of PICS for this test case that must be True for the test to be run"""
        return ["ACFREMON.S"]

    def steps_ACFREMON_2_1(self) -> list[TestStep]:
        steps = [
    ...
    @run_if_endpoint_matches(has_cluster(Clusters.ActivatedCarbonFilterMonitoring))
    async def test_ACFREMON_2_1(self):
    ...
    async def test_checkReplacementProductStruct(self, 
                                 endpoint: int = None, 
                                 cluster: Clusters.ActivatedCarbonFilterMonitoring = None, 
